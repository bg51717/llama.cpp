...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_LLAMA_MHA2MLA_ABSORB, "llama-mha2mla_absorb" },
    { LLM_ARCH_DECI,             "deci"             },
    ...
    { LLM_ARCH_QWEN3_MHA2MLA,    "qwen3-mha2mla"    },
...
static const std::map<llm_arch, std::map<llm_tensor, const char *>> LLM_TENSOR_NAMES = {
    ...
    },
    {
        LLM_ARCH_LLAMA_MHA2MLA,
        {
            ...
            { LLM_TENSOR_ATTN_NORM,       "blk.%d.attn_norm" },
            { LLM_TENSOR_ATTN_Q,          "blk.%d.attn_q" },
            { LLM_TENSOR_ATTN_K_R,        "blk.%d.attn_k_r" },
            { LLM_TENSOR_ATTN_DOWN_KV,    "blk.%d.attn_down_kv" },
            { LLM_TENSOR_ATTN_UP_K,       "blk.%d.attn_up_k" },
            { LLM_TENSOR_ATTN_UP_V,       "blk.%d.attn_up_v" },
            { LLM_TENSOR_ATTN_ROPE_Q_IDX, "blk.%d.attn_rope_q_idx"},
            { LLM_TENSOR_ATTN_ROPE_K_IDX, "blk.%d.attn_rope_k_idx"},
            { LLM_TENSOR_ATTN_OUT,        "blk.%d.attn_output" },
            { LLM_TENSOR_ATTN_ROT_EMBD,   "blk.%d.attn_rot_embd" },
            { LLM_TENSOR_FFN_GATE_INP,    "blk.%d.ffn_gate_inp" },
            { LLM_TENSOR_FFN_NORM,        "blk.%d.ffn_norm" },
    ...
    },
    {
        LLM_ARCH_QWEN3_MHA2MLA,
        {
            ...
            { LLM_TENSOR_ATTN_ROPE_Q_IDX, "blk.%d.attn_rope_q_idx"},
            { LLM_TENSOR_ATTN_ROPE_K_IDX, "blk.%d.attn_rope_k_idx"},
            // { LLM_TENSOR_ATTN_K_R_NORM,   "blk.%d.attn_k_r_norm" },
            // { LLM_TENSOR_ATTN_K_C_NORM,   "blk.%d.attn_k_c_norm" },
            { LLM_TENSOR_ATTN_K_NORM,     "blk.%d.attn_k_norm" },
            { LLM_TENSOR_ATTN_OUT,        "blk.%d.attn_output" },
            { LLM_TENSOR_FFN_NORM,        "blk.%d.ffn_norm" },
            { LLM_TENSOR_FFN_GATE,        "blk.%d.ffn_gate" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_ROPE_Q_IDX,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_ROPE_K_IDX,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    ...
    {LLM_TENSOR_ATTN_K_R_NORM,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ATTN_K_C_NORM,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
